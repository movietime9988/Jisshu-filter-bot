...
API_ID = int(environ.get("API_ID", "28757263"))
API_HASH = environ.get("API_HASH", "5115257eb1b402636d352fa52b286373")
BOT_TOKEN = environ.get("BOT_TOKEN", "7706186834:AAEsolKHJ3dSFisT6yUuilVwx1MEkL3pO_g")
PORT = environ.get("PORT", "8082")

# Owners
ADMINS = [
    int(admin) if id_pattern.search(admin) else admin
    for admin in environ.get("ADMINS", "8165892487").split()
]
OWNER_USERNAME = environ.get(
    "OWNER_USERNAME", "Abcd99286"
)  # without @ or https://t.me/
USERNAME = environ.get("USERNAME", "#Abcd99286")  # ADMIN USERNAME

# Database Channel
CHANNELS = [
    int(ch) if id_pattern.search(ch) else ch
    for ch in environ.get("CHANNELS", "-1002842760343").split()
]

# ForceSub Channel & Log Channels
AUTH_CHANNEL = int(environ.get("AUTH_CHANNEL", "0"))
AUTH_REQ_CHANNEL = int(environ.get("AUTH_REQ_CHANNEL", "0"))
LOG_CHANNEL = int(environ.get("LOG_CHANNEL", "-1002743280193"))
LOG_API_CHANNEL = int(environ.get("LOG_API_CHANNEL", "0"))
LOG_VR_CHANNEL = int(environ.get("LOG_VR_CHANNEL", "0"))

# MongoDB
DATABASE_URI = environ.get("DATABASE_URI", "mongodb+srv://Govieed:Govieed@govieed.vg291mc.mongodb.net/?retryWrites=true&w=majority&appName=Govieed")
DATABASE_NAME = environ.get("DATABASE_NAME", "Govieed")

# Files index database url
FILES_DATABASE = environ.get("FILES_DATABASE", "mongodb+srv://Govieed:<db_password>@govieed.vg291mc.mongodb.net/?retryWrites=true&w=majority&appName=Govieed")
...
START_IMG = (
    environ.get(
        "START_IMG",
        "https://files.catbox.moe/7ldisu.jpg",
    )
).split()
